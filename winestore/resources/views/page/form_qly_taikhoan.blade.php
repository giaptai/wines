...
<div class="p-3 row justify-content-between sticky-top bg-light">
    ...
    <div class="col-md-5">
        <div class="input-group">
            ...
            <input type="tel" class="form-control form-control-sm" placeholder="Số điện thoại" id="phone_id">
            <button class="btn btn-sm btn-primary" type="button" onclick="searched()"><i class="fa-solid fa-magnifying-glass"></i></button>
        </div>
    </div>
</div>
