    ...
    <div class="row row-cols-2 row-cols-md-4 g-2 mb-3 justify-content-between">
        ...
        <div class="col-md-4 text-white">
            <div class="card h-100 border-0">
                ...
                <div class="card-footer bg-warning"><a class="text-white" href="{{ route('customers') }}">Danh sách tài
                        khoản</a></div>
            </div>
        </div>
        <div class="col-md-4 text-white">
            <div class="card h-100 border-0">
                ...
                <div class="card-footer bg-danger"><a class="text-white" href="{{ route('orders') }}">Danh sách đơn
                        hàng</a></div>
            </div>
        </div>
    </div>
