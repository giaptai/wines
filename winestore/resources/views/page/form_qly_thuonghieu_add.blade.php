...
<div class="p-5">
    <form method="get" action="{{ route('add-product-add') }}"
        ...
        <h4 class="title" >Thêm thương hiệu</h4>

        <div class="mb-3 row">
            <label for="staticEmail" class="col-sm-2 col-form-label fw-semibold">Tên</label>
            <div class="col-sm-10">
                <input type="text" class="form-control-plaintext" id="name-brand" value="email@example.com">
            </div>
        </div>
        <div class="mb-3 row">
        ...
        <div class="d-flex gx-2">
            <a type="button" class="btn btn-secondary me-3" href="{{ route('brands') }}" >Quay lại</a>
