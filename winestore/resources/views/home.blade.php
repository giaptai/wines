                ...
                <div class="row row-cols-1 row-cols-lg-3 gy-2 align-items-stretch">
                    <div class="col">
                        <div class="card card-cover h-100  text-bg-dark rounded-4 shadow-lg"
                            ...
                            <div
                                class="d-flex h-100 p-5  text-white text-shadow-1 align-items-center align-self-center">
                    ...
                    {{-- <div class="col">
                        <div class="card card-cover h-100  text-bg-dark rounded-4 shadow-lg"
                            style="background-image: url('https://us.123rf.com/450wm/alfastudio/alfastudio1708/alfastudio170800724/83369587-a-glass-of-red-wine-and-cut-ham-with-basil-and-pepper-on-a-black-background-tasty-healthy-delicious-.jpg?ver=6');">
                            <div class="d-flex h-100 p-5 pb-3 text-shadow-1">
                                <h3 class="mt-5 pt-5 pb-4 display-6 lh-1 fw-bold">Vang trắng
                                </h3>
